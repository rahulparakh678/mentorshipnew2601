...
Route::get('/sessionsRecording/create','Admin\SessionRecordingController@create')->name('sessionsRecording.create');
...
//session Recordings
// Route::get('/sessionsRecording/create', [SessionRecordingController::class, 'create'])->name('sessionsRecording.create');

// Route::get('/get-sessions/{mentorId}', [SessionRecordingController::class, 'getSessions'])->name('get.sessions');
